    ...
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      {error && (
        <div className={`fixed top-20 left-1/2 transform -translate-x-1/2 z-50 ${
          isDarkMode 
            ? 'bg-gradient-to-r from-red-900/90 to-pink-900/90 border-red-700 text-red-200' 
      ...
      <header className={`fixed top-0 left-0 right-0 ${
        isDarkMode 
          ? 'bg-gradient-to-r from-gray-900/95 via-gray-800/90 to-gray-900/95 border-gray-700' 
          : 'bg-gradient-to-r from-white/95 via-white/90 to-white/95 border-blue-100'
      } backdrop-blur-xl shadow-lg border-b z-50 transition-colors duration-300`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                onClick={() => router.push('/')}
                className={`group flex items-center space-x-2 px-5 py-2.5 ${
                  isDarkMode 
                    ? 'bg-gradient-to-r from-blue-700 to-cyan-600 hover:from-blue-600 hover:to-cyan-500' 
                    : 'bg-gradient-to-r from-blue-500 to-cyan-400 hover:from-blue-600 hover:to-cyan-500'
                } text-white rounded-xl transition-all duration-300 shadow-lg hover:shadow-blue-500/30 hover:scale-105`}
              >
              ...
              <button
                ...
                } text-white rounded-xl transition-all duration-300 shadow-lg hover:shadow-purple-500/30 hover:scale-105`}
              >
              ...
              <button
                ...
                } text-white rounded-xl transition-all duration-300 shadow-lg hover:shadow-red-500/30 hover:scale-105`}
              >
        ...
        <div className="relative z-20 h-full max-w-7xl mx-auto px-6 flex items-center gap-8 lg:gap-12">
          <div className="w-full md:w-1/2 text-white animate-fadeIn">
            <div className={`inline-block px-4 py-2 ${
              isDarkMode 
                ? 'bg-gradient-to-r from-blue-700/30 to-cyan-600/30 border-white/30' 
                : 'bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border-white/20'
            } backdrop-blur-sm rounded-full border mb-6`}>
              ...
              <div className="mb-8">
                ...
                {selectedCategory.featured && (
                  <span className={`inline-flex items-center ${
                    isDarkMode 
                      ? 'bg-gradient-to-r from-yellow-600 via-orange-600 to-yellow-500 border-yellow-400/50' 
                      : 'bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-500 border-yellow-300/50'
                  } text-white px-8 py-3 rounded-full text-lg font-bold shadow-2xl border-2 animate-bounce-slow`}>
              ...
              <div className={`relative ${
                ...
                <div className="absolute left-2 top-1/2 -translate-y-1/2 z-10">
                  <button
                    ...
                    className={`${
                      isDarkMode 
                        ? 'bg-gray-800/90 hover:bg-gray-700 text-blue-400' 
                        : 'bg-white/90 hover:bg-white text-blue-700'
                    } backdrop-blur-sm p-2 rounded-full shadow-lg transition-all hover:scale-110`}
                  >
                ...
                >
                  <div className="flex space-x-6 py-2">
                    {timeSlots.map((slot, index) => (
                      <button
                        key={slot.id}
                        className={`flex-shrink-0 w-28 p-3 rounded-xl cursor-pointer transition-all duration-300 ${
                          selectedTimeSlot?.id === slot.id 
                            ? `${
                                isDarkMode 
                                  ? 'bg-gradient-to-r from-blue-600 to-cyan-500 ring-white/30' 
                                  : 'bg-gradient-to-r from-blue-500 to-cyan-400 ring-white/50'
                              } text-white shadow-lg scale-105 ring-2` 
                            : `${
                                isDarkMode 
            ...
            {selectedCategory && (
              <button
                ...
                className={`group relative mt-6 px-10 py-4 ${
                  isDarkMode 
                    ? 'bg-gradient-to-r from-green-600 via-emerald-600 to-teal-700 hover:from-green-700 hover:via-emerald-700 hover:to-teal-800' 
                    : 'bg-gradient-to-r from-green-500 via-emerald-500 to-teal-600 hover:from-green-600 hover:via-emerald-600 hover:to-teal-700'
                } text-white rounded-2xl font-bold text-lg transition-all duration-300 shadow-2xl hover:shadow-emerald-500/40 hover:scale-105 overflow-hidden`}
              >
            ...
            <div className="mt-10">
              <button
                onClick={() => router.push('/')}
                className={`group flex items-center space-x-3 px-6 py-3 ${
                  isDarkMode 
                    ? 'bg-gradient-to-r from-white/20 to-white/10 border-white/30 hover:from-white/30 hover:to-white/20 hover:border-white/50' 
                    : 'bg-gradient-to-r from-white/20 to-white/10 border-white/30 hover:from-white/30 hover:to-white/20 hover:border-white/50'
            ...
            <button
              ...
              className={`absolute left-4 top-1/2 -translate-y-1/2 z-30 p-4 rounded-full shadow-2xl transition-all duration-300 ${
                canScrollLeft 
                  ? `${
                      isDarkMode 
                        ? 'bg-gradient-to-r from-gray-800 to-gray-700 text-blue-400 hover:from-gray-700 hover:to-gray-600 hover:text-blue-300' 
                        : 'bg-gradient-to-r from-white to-blue-50 text-blue-700 hover:from-blue-50 hover:to-white hover:text-blue-800'
                    } shadow-lg hover:scale-110 cursor-pointer` 
                  : `${
                      isDarkMode 
                        ? 'bg-gray-900/50 text-white/30' 
      ...
      {showActivities && (
        <section id="activities-section" className={`py-20 ${
          isDarkMode 
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              <div className={`inline-block px-6 py-2 ${
                isDarkMode 
                  ? 'bg-gradient-to-r from-blue-900/30 to-cyan-900/30 text-blue-300' 
              ...
              <h2 className={`text-4xl md:text-5xl font-bold mb-4 ${
                ...
                Discover <span className={`bg-gradient-to-r ${
                  isDarkMode 
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredActivities.map((activity) => {
                ...
                return (
                  <div key={activity.id} className={`group rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] ${
                    isDarkMode 
                   ...
                   <div className="relative h-56 overflow-hidden">
                      ...
                      <div className={`absolute bottom-4 right-4 ${
                        isDarkMode ? 'bg-gray-900/80' : 'bg-black/70'
                      } backdrop-blur-sm text-white px-3 py-1.5 rounded-full text-xs`}>
                      ...
                      <div className={`mb-4 text-sm space-y-2 ${
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            }`}>Start: {new Date(activity.startDate).toLocaleDateString()}</div>
                            <div className={`text-xs ${
                              isDarkMode ? 'text-gray-400' : 'text-gray-500'
                            }`}>{formatTime(activity.startDate)}</div>
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                          ...
                          <div>
                            <div className={`font-medium ${
                              isDarkMode ? 'text-gray-200' : 'text-gray-800'
                            }`}>End: {new Date(activity.endDate).toLocaleDateString()}</div>
                            <div className={`text-xs ${
                              isDarkMode ? 'text-gray-400' : 'text-gray-500'
                            }`}>{formatTime(activity.endDate)}</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className={`flex justify-between items-center pt-4 ${
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            } text-white rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-blue-500/30 hover:scale-105 flex items-center gap-2`}
                          >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center mt-16 flex flex-col sm:flex-row justify-center gap-4">
              <button
                ...
                } text-white rounded-xl transition-all duration-300 shadow-lg hover:shadow-gray-500/30 hover:scale-105 flex items-center justify-center gap-3`}
              >
                <svg className="w-5 h-5 group-hover:-translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                </svg>
              ...
              <button
                ...
                } text-white rounded-xl transition-all duration-300 shadow-lg hover:shadow-blue-500/30 hover:scale-105 flex items-center justify-center gap-3`}
              >
                <svg className="w-5 h-5 group-hover:-translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
      ...
      <style jsx>{`
        ...
        /* Stile për kthimin në kategoritë */
        .categories-scroll {
          scroll-margin-top: 80px;
        }
        
        /* Sigurohu që seksioni i kategorive të ketë lartësi të mjaftueshme */
        #categories-section {
          min-height: 100vh;
          position: relative;
        }
        
        /* Smooth transitions për dark mode */
        * {
